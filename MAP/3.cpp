...
bool check9(){//just have fun!
	...
	if(itQ == itO) return 0; std::cout << "1\n"; if(citQ == citO) return 0; std::cout << "1\n"; 
	if(!(itQ != itO)) return 0;  std::cout << "1\n"; if(!(citQ != citO)) return 0; std::cout << "1\n"; 
	if(itQ == citO) return 0; std::cout << "1\n";  if(itO == citQ) return 0; std::cout << "1\n"; 
	if(!(itQ != citO)) return 0;  std::cout << "1\n"; if(!(itO != citQ)) return 0; std::cout << "1\n"; 
	if(!(citQ == itQ)) return 0;  std::cout << "1\n"; if(citQ != itQ) return 0;  std::cout << "1\n"; 
	return 1;
}
